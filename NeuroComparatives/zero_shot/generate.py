...
def _generate_beam_search(
    ...
    while cur_len < max_length:
        ...
        if do_sample:
            ...
            pick_scores, pick_tokens, constraints, num_mets = topk_huggingface(timestep=cur_len - init_length,
                                                                               ...
                                                                               temp_past=past,
                                                                               score_history=score_history.cpu().numpy() if score_history is not None else None,
                                                                               model_specific_kwargs=model_specific_kwargs)
    ...
    sent_lengths = input_ids.new(output_batch_size * output_num_return_sequences_per_batch)
    best = []
