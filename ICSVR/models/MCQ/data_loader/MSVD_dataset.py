...
from base.base_dataset import TextVideoDataset, MCQVideoDataset


class MSVD_train(MCQVideoDataset):
    def _load_metadata(self):
        json_fp = os.path.join(self.data_dir, 'MSVD_fit_' + self.typ + '.json')
        ...
        train_list_path = "msvd_train_list.txt"
        val_list_path = "msvd_val_list.txt"
        test_list_path = "msvd_test_list.txt"
    ...
    def _get_video_path(self, sample):
        return os.path.join(self.video_data_dir, sample.name + '.avi'), sample.name + '.avi'
