...
class DiDeMoDataset(Dataset):
    def __init__(
        ...
        video_id_path_dict = {}
        video_id_path_dict["train"] = os.path.join(self.data_path, "didemo_train_list.txt")
        video_id_path_dict["train_test"] = os.path.join(self.data_path, "didemo_train_list.txt")
        video_id_path_dict["val"] = os.path.join(self.data_path, "didemo_val_list.txt")
        video_id_path_dict["test"] = os.path.join(self.data_path, "didemo_test_list.txt")

        video_json_path_dict = {}
        video_json_path_dict["train"] = os.path.join(self.data_path, "didemo_train_data.json")
        video_json_path_dict["train_test"] = os.path.join(self.data_path, "didemo_train_data.json")
        video_json_path_dict["val"] = os.path.join(self.data_path, "didemo_val_data.json")
        video_json_path_dict["test"] = os.path.join(self.data_path, "DIDEMO_clip4clip_" + self.typ + ".json")
        ...
        if(self.subset == "train"):
            print("Train File: {} and Video Number: {} ".format(video_json_path_dict["train"], len(video_ids)))
        elif(self.subset == "train_test"):
            print("Train File: {} and Video Number: {} ".format(video_json_path_dict["train_test"], len(video_ids)))
        elif(self.subset == "val"):
            print("Validation File: {} and Video Number: {} ".format(video_json_path_dict["val"], len(video_ids)))
        else:
            print("Test File: {} and Video Number: {} ".format(video_json_path_dict["test"], len(video_ids)))
        print("#####################################################################################")

        if(self.subset == 'train' or self.subset == 'val' or self.subset == 'train_test'):
            caption_dict = {}
