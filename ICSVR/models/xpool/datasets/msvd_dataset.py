...
class MSVDDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type = 'train', img_transforms=None):
        ...
        db_file = '../../data/xpool_data/MSVD_'
        if(config.testtyp == 'part'):
            db_file = db_file + config.testtyp + '_'  + 'xpool_' + config.typ + '.json'
        else:
            db_file = db_file + 'xpool_' + config.typ + '.json'
        test_file = '../../data/xpool_data/test_list.txt'
        train_file = '../../data/xpool_data/train_list.txt'
