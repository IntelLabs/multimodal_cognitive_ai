...
class MSVD_DataLoader(Dataset):
    ...
    def __init__(
        ...
        if(self.testtyp == 'part'):
            caption_file = os.path.join(self.data_path, "MSVD_part_clip4clip_" + self.typ + ".pkl")
            print("Testing on {}".format("MSVD_part_clip4clip_" + self.typ + ".pkl"))
        else:
            caption_file = os.path.join(self.data_path, "MSVD_clip4clip_" + self.typ + ".pkl")
            print("Testing on {}".format("MSVD_clip4clip_" + self.typ + ".pkl"))
